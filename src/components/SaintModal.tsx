...
const SaintModal: React.FC<SaintModalProps> = ({ saint, isOpen, onClose }) => {
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <div className="flex items-center justify-center lg:justify-start space-x-2 text-gray-600 bg-white/70 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
                          ...
                          <span className="font-medium">{saint.period}</span>
                        </div>
                        <div className="flex items-center justify-center lg:justify-start space-x-2 text-gray-600 bg-white/70 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
                          <MapPin className="w-5 h-5 text-orange-500" />
                          <span className="font-medium">{saint.region}</span>
                        </div>
                      </div>
