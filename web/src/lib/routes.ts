...
const MIGRATED_PATHS = ['/prabhu-ki-leelaayen', '/blog', '/blog/hindi', '/blog/english'];
const MIGRATED_PREFIXES = ['/prabhu-ki-leelaayen/book/', '/prabhu-ki-leelaayen/read/', '/blog/post/', '/blog/category/'];
