...
const MIGRATED_PATHS = ['/', '/prabhu-ki-leelaayen', '/blog', '/blog/hindi', '/blog/english', '/saints', '/divine', '/bhajans', '/naam-jap', '/horoscope'];
const MIGRATED_PREFIXES = ['/prabhu-ki-leelaayen/book/', '/prabhu-ki-leelaayen/read/', '/blog/post/', '/blog/category/', '/saints/', '/divine/', '/bhajans/'];
