...
const MIGRATED_PATHS = ['/', '/prabhu-ki-leelaayen', '/blog', '/blog/hindi', '/blog/english', '/saints', '/divine', '/bhajans', '/naam-jap', '/horoscope', '/privacy-policy', '/terms-of-service', '/donation', '/about', '/jeevani', '/santvaani-space'];
