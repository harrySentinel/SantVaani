...
export default function Home() {
  ...
  const features = [
    { title: t('features.saints.title'), description: t('features.saints.description'), to: '/saints' },
    { title: t('features.divine.title'), description: t('features.divine.description'), to: '/divine' },
  ];
