...
const AshramContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For now, just log the data (replace with EmailJS when configured)
      console.log('Ashram/Orphanage Contact Form submitted:', formData);
      
      // TODO: Uncomment when EmailJS is configured
      // const success = await sendAshramApplication(formData);
      // if (!success) {
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
        ...
        <p className="text-green-600 mb-4">
          Thank you for reaching out. Our team will review your application and contact you within 3-5 working days.
        </p>
        <div className="bg-white p-4 rounded-lg border border-green-200">
          <p className="text-sm text-green-700">
            <strong>Next Steps:</strong><br />
            • We'll verify the provided information<br />
            • Our team may call for additional details<br />
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
        ...
        <div className="pt-6 border-t border-gray-200">
          <button
            ...
            className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 px-6 rounded-lg hover:from-orange-600 hover:to-red-600 transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 text-lg font-semibold"
          >
            {isSubmitting ? (
              <>
